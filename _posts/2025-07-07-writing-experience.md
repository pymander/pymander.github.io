---
title: Writing Experience (Emacs Carnival)
author: "Erik L. Arneson"
layout: post
permalink: /2025/07/writing-experience-emacs-carnival
comments: true
tags:
- emacs
- writing
...
This is my contribution to month two of [Greg Newman's Emacs Carnival](https://gregnewman.io/blog/emacs-carnival-2025-07-writing-experience/). The topic this month is "Writing Experience," which is perfect, since I write in Emacs all the time. In fact, I am writing this blog post in Emacs right now!
<!--more-->
...
**I do not have to write in Word or Google Docs.** The export functions in org-mode do a great job creating Word files, ODT files, HTML files, and all kinds of formats. If org-mode's export abilities aren't good enough, it can also interface with [pandoc](https://pandoc.org/) to cover all the other cases! This means I get to use all of my familiar tools and processes when writing, and I don't have to worry about [awful word processing software](https://lions-way-presents.captivate.fm/episode/the-word-processor-war/)!
...
I have a hotkey connected to [writeroom-mode](https://github.com/joostkremers/writeroom-mode), which plonks me right into a full-screen, distraction-free writing mode. Easy as pie! This means that when I really need to get down to business and get a lot of writing done, I don't need to switch to a new app, leave my familiar tools behind, or go through any extra trouble. It's just right here, built in.
